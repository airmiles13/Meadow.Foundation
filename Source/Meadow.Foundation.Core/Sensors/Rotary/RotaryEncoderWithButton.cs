...
namespace Meadow.Foundation.Sensors.Rotary
{
    ...
    public class RotaryEncoderWithButton : RotaryEncoder, IRotaryEncoderWithButton
    {
        ...
        public RotaryEncoderWithButton(IIODevice device, IPin aPhasePin, IPin bPhasePin, IPin buttonPin, ResistorMode resistor, int debounceDuration = 20)
        ...
        public RotaryEncoderWithButton(IIODevice device, IDigitalInputPort aPhasePin, IDigitalInputPort bPhasePin, IPin buttonPin, ResistorMode resistor, int debounceDuration = 20 )
